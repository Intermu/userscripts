...
A.ok('the SheetJS fidelity limit is stated to the operator',
  /styles, charts, images, conditional formatting, data validation/.test(TEXT));
...
A.ok('the version was bumped (an unbumped push reaches nobody)', /@version\s+0\.13\.0/.test(TEXT));
