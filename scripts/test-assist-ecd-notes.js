...
var t7 = Promise.all([t2, t3, t4, t5, t6]).then(function () {
  ...
  // M8: neuter the hyphen strip -> the live 2027 proposal comes straight back. This is the
  // control for the W-386564 defect: without it the probe above would pass on any source that
  // merely happens to produce a Friday. Numbered past M7 (write-echo) to avoid colliding with
  // the write-echo mutations' own M6/M7, which share this scope.
  var m8 = build({
