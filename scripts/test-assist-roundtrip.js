...
(async function main() {
  ...
  A.ok('core @version is 1.89.1', coreFull.indexOf('// @version      1.89.1') !== -1, 'core version drift');
  A.ok('core banner says WO Assist 2.76', coreFull.indexOf('WO Assist 2.76') !== -1, 'module banner drift');
