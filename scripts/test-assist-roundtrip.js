...
(async function main() {
  ...
  A.ok('core @version is 1.81.1', coreFull.indexOf('// @version      1.81.1') !== -1, 'core version drift');
  A.ok('core banner says WO Assist 2.72', coreFull.indexOf('WO Assist 2.72') !== -1, 'module banner drift');
