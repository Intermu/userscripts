...
(async function main() {
  ...
  A.ok('core @version is 1.88.0', coreFull.indexOf('// @version      1.88.0') !== -1, 'core version drift');
  A.ok('core banner says WO Assist 2.75', coreFull.indexOf('WO Assist 2.75') !== -1, 'module banner drift');
